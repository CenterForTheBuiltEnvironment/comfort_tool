...
function get_fp_real(alt, az, posture) {
  ...
  if ((posture == "standing") | (posture == "supine")) {
    var fp_table = [
      [0.25375, 0.25375, 0.22765, 0.18705, 0.14935, 0.1044, 0.05945],
    ...
    var fp_table = [
      [0.20184, 0.225504, 0.21228, 0.210888, 0.182352, 0.155904, 0.123192],
...
function ERF(alt, az, posture, Idir, tsol, fsvv, fbes, asa, tsol_factor) {
  ...
  var E_refl =
    ...
    0.5 *
    tsol *
    (Idir * Math.sin(alt * DEG_TO_RAD) + Idiff) *
    Rfloor;
...
function ERF_test() {
  ...
  var v = [
    [0, 120, "seated", 800, 0.5, 0.5, 0.5, 0.7],
  ...
  var res = [
    [26.872926315789474, 6.435087719298245],
