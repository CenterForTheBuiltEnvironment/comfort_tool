...
test("cooling effect", () => {
  ...
  expect(comf.cooling_effect(25, 25, 0.5, 50, 1, 0.6)).toBeCloseTo(2.17, 1);
  expect(comf.cooling_effect(27, 25, 0.5, 50, 1, 0.6)).toBeCloseTo(1.85, 1);
  expect(comf.cooling_effect(29, 25, 0.5, 50, 1, 0.6)).toBeCloseTo(1.63, 2);
  expect(comf.cooling_effect(31, 25, 0.5, 50, 1, 0.6)).toBeCloseTo(1.42, 2);
  expect(comf.cooling_effect(25, 27, 0.5, 50, 1, 0.6)).toBeCloseTo(2.44, 2);
  expect(comf.cooling_effect(25, 29, 0.5, 50, 1, 0.6)).toBeCloseTo(2.81, 1);
  expect(comf.cooling_effect(25, 25, 0.2, 50, 1, 0.6)).toBeCloseTo(0.66, 2);
  expect(comf.cooling_effect(25, 25, 0.8, 50, 1, 0.6)).toBeCloseTo(2.93, 2);
  expect(comf.cooling_effect(25, 25, 0.0, 50, 1, 0.6)).toBeCloseTo(0, 2);
  expect(comf.cooling_effect(25, 25, 0.5, 60, 1, 0.6)).toBeCloseTo(2.13, 2);
  expect(comf.cooling_effect(25, 25, 0.5, 80, 1, 0.6)).toBeCloseTo(2.06, 2);
  expect(comf.cooling_effect(25, 25, 0.5, 20, 1, 0.6)).toBeCloseTo(2.29, 2);
  expect(comf.cooling_effect(25, 25, 0.5, 60, 1.3, 0.6)).toBeCloseTo(2.83, 2);
  expect(comf.cooling_effect(25, 25, 0.5, 60, 1.6, 0.6)).toBeCloseTo(3.5, 1);
  expect(comf.cooling_effect(25, 25, 0.5, 60, 1, 0.3)).toBeCloseTo(2.41, 2);
  expect(comf.cooling_effect(25, 25, 0.5, 60, 1, 1)).toBeCloseTo(2.05, 2);
});
