var pc = new function () {
    ...
    this.mousemove = function () {
        ...
        let mouseEnt = (1.006 * mouseDBT + mouseHR * (2501 + 1.86 * mouseDBT)) / 1000;
    ...
    this.drawComfortRegion = function (data, i) {
        ...
        pc.svg.append("path")
            ...
            .attr("class", "comfortzone" + i).attr("id", "psych-comfortzone" + i)
    ...
    this.drawPoint = function (data, i) {
        ...
        pc.svg.append("circle")
            .attr("class", "point" + i).attr('id', 'psych-outer' + i)
            .attr("r", 12);

        pc.svg.append("circle")
            .attr("class", "point" + i).attr('id', 'psych-inner' + i)
            .attr("r", 2);

        d3.select("#psych-inner" + i).moveToFront()
            .attr("cx", pc.db_scale(data[0].db))
            .attr("cy", pc.hr_scale(1000 * data[0].hr));
        d3.select("#psych-outer" + i).moveToFront()
            .attr("cx", pc.db_scale(data[0].db))
            .attr("cy", pc.hr_scale(1000 * data[0].hr))
    ...
    this.redrawPoint = function (data, i) {
        ...
        d3.select("#psych-inner" + i).moveToFront().transition()
            .attr("cx", pc.db_scale(data[0].db))
            .attr("cy", pc.hr_scale(1000 * data[0].hr));
        d3.select("#psych-outer" + i).moveToFront().transition()
            .attr("cx", pc.db_scale(data[0].db))
            .attr("cy", pc.hr_scale(1000 * data[0].hr))
