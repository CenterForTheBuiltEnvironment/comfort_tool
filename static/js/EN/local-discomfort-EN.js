...
function asymRisk(rad_DT_warmC, rad_DT_coolC, rad_DT_warmW, rad_DT_coolW) {
    ...
    return [(max_PPD >= 10), (max_PPD >= 5), [warmC_PPD, coolC_PPD, warmW_PPD, coolW_PPD]]
...
function verticalRisk(T_head, T_ankle) {
    ...
    return [(Vertical_DT >= 8 || Vertical_PPD >= 10), (Vertical_DT >= 8 || Vertical_PPD >= 5), (Vertical_DT >= 8 || Vertical_PPD >= 3), Vertical_PPD]
}
...
function draftRisk(local_ta, local_vel) {
	if (local_vel < 0.05) { local_vel = 0.05 }

	var Tu = 40; // local turbulence intensity (40% if unknown)
    var DR = (34 - local_ta) * Math.pow((local_vel - 0.05),0.62) * (0.37 * local_vel * Tu + 3.14);
...
function updateLocalDisc() {
    ...
    if (asym_res[2][0] >= 10) {
	    ...
	    msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][0].toFixed(0) + "%" + "&nbsp; (III)";
        $("#rad-warmC-res").css('color', 'green')
    } else {
        msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][0].toFixed(0) + "%" + "&nbsp; (I or II)";
        $("#rad-warmC-res").css('color', 'green')
    }
    ...
    if (asym_res[2][1] >= 10) {
	    ...
	    msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][1].toFixed(0) + "%" + "&nbsp; (III)";
        $("#rad-coolC-res").css('color', 'green')
    } else {
        msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][1].toFixed(0) + "%" + "&nbsp; (I or II)";
        $("#rad-coolC-res").css('color', 'green')
    }
    ...
    if (asym_res[2][2] >= 10) {
	    ...
	    msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][2].toFixed(0) + "%" + "&nbsp; (III)";
        $("#rad-warmW-res").css('color', 'green')
    } else {
        msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][2].toFixed(0) + "%"  + "&nbsp; (I or II)";
        $("#rad-warmW-res").css('color', 'green')
    }
    ...
    if (asym_res[2][3] >= 10) {
	    ...
	    msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][3].toFixed(0) + "%" + "&nbsp; (III)";
        $("#rad-coolW-res").css('color', 'green')
    } else {
        msg = "&#10004; &nbsp; &nbsp; " + asym_res[2][3].toFixed(0) + "%" + "&nbsp; (I or II)";
        $("#rad-coolW-res").css('color', 'green')
    }
    ...
    if (vert_res[0]) {
	    ...
	    msg = "&#10004; &nbsp; &nbsp; " + vert_res[3].toFixed(0) + "%" + "&nbsp; (III)";
        $("#vert-disc").css('color', 'green')
    } else if (vert_res[2]) {
	    msg = "&#10004; &nbsp; &nbsp; " + vert_res[3].toFixed(0) + "%" + "&nbsp; (II)";
        $("#vert-disc").css('color', 'green')
    } else {
        msg = "&#10004; &nbsp; &nbsp; " + vert_res[3].toFixed(0) + "%" + "&nbsp; (I)";
        $("#vert-disc").css('color', 'green')
    }
    $("#vert-disc").html(msg);
    ...
    if (floor_res[0]) {
	    ...
	    msg = "&#10004; &nbsp; &nbsp; " + floor_res[2].toFixed(0) + "%" + "&nbsp; (III)";
        $("#floor-disc").css('color', 'green')
    } else {
        msg = "&#10004; &nbsp; &nbsp; " + floor_res[2].toFixed(0) + "%" + "&nbsp; (I or II)";
        $("#floor-disc").css('color', 'green')
    }
    $("#floor-disc").html(msg);
    ...
    if (draft_res[0]) {
        ...
        msg = "&#10004; &nbsp; &nbsp; " + draft_res[3].toFixed(0) + "%" + "&nbsp; (III)";
        $("#draft-disc").css('color', 'green')
    } else if (draft_res[2]) {
        msg = "&#10004; &nbsp; &nbsp; " + draft_res[3].toFixed(0) + "%" + "&nbsp; (II)";
        $("#draft-disc").css('color', 'green')
    } else {
        msg = "&#10004; &nbsp; &nbsp; " + draft_res[3].toFixed(0) + "%" + "&nbsp; (I)";
        $("#draft-disc").css('color', 'green')
    }
    $("#draft-disc").html(msg);
