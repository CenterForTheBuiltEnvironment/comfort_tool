...
pc.drawTempLines = function () {
  ...
  if (isCelsius) {
    pc.svg
      .append("text")
      .text(left.db.toFixed(1))
      .attr("class", "temp-label")
      .attr("id", "left-temp-label")
      .attr("x", pc.db_scale(left.db) - 31)
      .attr("y", pc.hr_scale(0) - 2)
      .attr("clip-path", "url(#clip)");
    pc.svg
      .append("text")
      .text(right.db.toFixed(1))
      .attr("class", "temp-label")
      .attr("id", "right-temp-label")
    ...
    pc.svg
      .append("text")
      .text(util.CtoF(left.db).toFixed(1))
      .attr("class", "temp-label")
      .attr("id", "left-temp-label")
      .attr("x", pc.db_scale(left.db) - 31)
      .attr("y", pc.hr_scale(0) - 2)
    ...
    pc.svg
      .append("text")
      .text(util.CtoF(right.db).toFixed(1))
      .attr("class", "temp-label")
      .attr("id", "right-temp-label")
      .attr("x", pc.db_scale(right.db) + 4)
      .attr("y", pc.hr_scale(0) - 2)
  ...
  if (inner_range > 0) {
    ...
    pc.svg
      ...
      .attr("class", "temp-line")
      .attr("id", "inner_right-line");
    if (isCelsius) {
      pc.svg
        .append("text")
        .text(inner_left.db.toFixed(1))
        .attr("class", "temp-label")
        .attr("id", "left-temp-label")
      ...
      pc.svg
        .append("text")
        .text(inner_right.db.toFixed(1))
        .attr("class", "temp-label")
        .attr("id", "inner_right-temp-label")
        .attr("x", pc.db_scale(inner_right.db) + 4)
        .attr("y", pc.hr_scale(0) - 2);
    } else {
      pc.svg
        .append("text")
        .text(util.CtoF(inner_left.db).toFixed(1))
        .attr("class", "temp-label")
        .attr("id", "left-temp-label")
        .attr("x", pc.db_scale(inner_left.db) - 31)
        .attr("y", pc.hr_scale(0) - 2);
      pc.svg
        .append("text")
        .text(util.CtoF(inner_right.db).toFixed(1))
        .attr("class", "temp-label")
        .attr("id", "inner_right-temp-label")
        .attr("x", pc.db_scale(inner_right.db) + 4)
        .attr("y", pc.hr_scale(0) - 2);
