...
bc.drawRHcurve = function (data) {
  d3.select("#svg-temphum")
    ...
    .attr("d", bc.pline(data))
    .attr("id", "rh-curve-temphum")
...
bc.findRHcurve = function (d, pmvlimit, factor) {
  ...
  function rhclos(rhx, target) {
    return function (db) {
      return (
        comf.pmvElevatedAirspeed(db, d.tr, d.vel, rhx, d.met, d.clo, 0).pmv -
        target
      );
    };
  }
...
bc.drawTempLines = function () {
  ...
  d3.select("#svg-temphum")
    ...
    .attr("class", "temp-line-temphum")
    .attr("id", "left-line-temphum");
  d3.select("#svg-temphum")
    .append("path")
    .attr("clip-path", "url(#clip)")
    .attr("d", bc.line(right_line))
    .attr("class", "temp-line-temphum")
    .attr("id", "right-line-temphum");
  if (isCelsius) {
    d3.select("#svg-temphum")
      .append("text")
      .text(temphum_left.db.toFixed(1))
    ...
    d3.select("#svg-temphum")
      .append("text")
      .text(temphum_right.db.toFixed(1))
      .attr("class", "temp-label-temphum")
    ...
    d3.select("#svg-temphum")
      .append("text")
      .text(util.CtoF(temphum_left.db).toFixed(1))
      .attr("class", "temp-label-temphum")
      .attr("id", "left-temp-label-temphum")
      .attr("x", bc.db_scale(temphum_left.db) - 31)
      .attr("y", bc.rh_scale(0) - 2)
    ...
    d3.select("#svg-temphum")
      .append("text")
      .text(util.CtoF(temphum_right.db).toFixed(1))
      .attr("class", "temp-label-temphum")
      .attr("id", "right-temp-label-temphum")
      .attr("x", bc.db_scale(temphum_right.db) + 4)
      .attr("y", bc.rh_scale(0) - 2)
  ...
  if (temphum_inner_range > 0) {
    d3.select("#svg-temphum")
      ...
      .attr("class", "temp-line-temphum")
      .attr("id", "inner_left-line-temphum");
    d3.select("#svg-temphum")
      .append("path")
      .attr("d", bc.line(inner_right_line))
      .attr("class", "temp-line-temphum")
      .attr("id", "inner_right-line-temphum");
    if (isCelsius) {
      d3.select("#svg-temphum")
        .append("text")
        .text(temphum_inner_left.db.toFixed(1))
        .attr("class", "temp-label-temphum")
      ...
      d3.select("#svg-temphum")
        .append("text")
        .text(temphum_inner_right.db.toFixed(1))
        .attr("class", "temp-label-temphum")
      ...
      d3.select("#svg-temphum")
        .append("text")
        .text(util.CtoF(temphum_inner_left.db).toFixed(1))
        .attr("class", "temp-label-temphum")
        .attr("id", "temphum_left-temp-label")
        .attr("x", bc.db_scale(temphum_inner_left.db) - 31)
        .attr("y", bc.rh_scale(0) - 2);
      d3.select("#svg-temphum")
        .append("text")
        .text(util.CtoF(temphum_inner_right.db).toFixed(1))
        .attr("class", "temp-label-temphum")
        .attr("id", "temphum_inner_right-temp-label")
        .attr("x", bc.db_scale(temphum_inner_right.db) + 4)
        .attr("y", bc.rh_scale(0) - 2);
