...
var ac = new function() {
    ...
    this.drawChart = function() {
        ...
        ac.svg.append("g")
            ...
            .call(top_axis.tickSubdivide(0).tickSize(-(ac.width - 2 * ac.margin), 0))
        ...
        ac.svg.append("g")
            ...
            .attr("opacity", "0")
            .attr("transform", "translate(" + ac.margin + ",0)")
            .call(top_axis_F.tickSubdivide(0).tickSize(-(ac.width - 2 * ac.margin), 0))

        ac.svg.append("g")
            .attr("class", "trm axis")
            .attr("id", "trm-axis-C")
            .attr("transform", "translate(0," + (ac.height - ac.rbmargin) + ")")
            .call(trm_axis.tickSubdivide(0).tickSize(-(ac.height - 2 * ac.rbmargin), 0))
        ...
        ac.svg.append("g")
            ...
            .attr("opacity", "0")
            .attr("transform", "translate(0," + (ac.height - ac.rbmargin) + ")")
            .call(trm_axis_F.tickSubdivide(0).tickSize(-(ac.height - 2 * ac.rbmargin), 0))
