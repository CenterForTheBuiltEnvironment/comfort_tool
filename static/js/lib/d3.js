...
(function () {
  ...
  function bv(a, b) {
    function f() {
      ...
      (c.lastIndex = 0),
        c.test(e) ||
          ((e = t(e + " " + a)), d ? (b.baseVal = e) : (this.className = e));
    }
    function g() {
          ...
          return (
            a.each(function (h, i, j) {
              ...
              function q(a) {
                ...
                if (c >= 1)
                  return r(), (bI = b), e.end.call(l, h, i), (bI = 0), 1;
              }
              function r() {
  ...
  function bO() {
    ...
    var d = bP() - b;
    d > 24
      ? (isFinite(d) && (clearTimeout(bN), (bN = setTimeout(bO, d))), (bM = 0))
      : ((bM = 1), bQ(bO));
  }
  function bP() {
    var a = null,
  ...
  function bR(a) {
    ...
    b[0] * c[1] < c[0] * b[1] &&
      ((b[0] *= -1), (b[1] *= -1), (d *= -1), (e *= -1)),
      (this.rotate =
        (d ? Math.atan2(b[1], b[0]) : Math.atan2(-c[0], c[1])) * bV),
      (this.translate = [a.e, a.f]),
      (this.scale = [d, f]),
      (this.skew = f ? Math.atan2(e, f) * bV : 0);
  }
  function bS(a, b) {
  ...
  function cb(a, b, c, d) {
    function g() {
      var g = Math.min(a.length, b.length) > 2 ? ci : ch,
        i = d ? ba : _;
  ...
  function cg(a, b) {
    return d3.format(
      ",." +
        Math.max(0, -Math.floor(Math.log(ce(a, b)[2]) / Math.LN10 + 0.01)) +
        "f"
    );
  }
  function ch(a, b, c, d) {
  ...
  function cj(a, b) {
    ...
    return (
      ...
      (d.domain = function (e) {
        return arguments.length
          ? ((b = e[0] < 0 ? cm : cl), (c = b.pow), a.domain(e.map(b)), d)
          : a.domain().map(c);
      }),
      (d.nice = function () {
      ...
      (d.tickFormat = function (a, e) {
        ...
        var f = a / d.ticks().length,
          g = b === cm ? ((h = -1e-12), Math.floor) : ((h = 1e-12), Math.ceil),
          h;
        return function (a) {
  ...
  function cN(a, b) {
    return a.length < 3
      ? cJ(a)
      : a[0] +
          cP((a.push(a[0]), a), cQ([a[a.length - 2]].concat(a, [a[1]]), b));
  }
  function cO(a, b, c) {
  ...
  function cR(a) {
    ...
    cZ(i, g, h);
    while (++b < c)
      (d = a[b]), g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), cZ(i, g, h);
    b = -1;
    while (++b < 2)
      g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), cZ(i, g, h);
    return i.join("");
  }
  function cS(a) {
    ...
    while (++c < d)
      (e = a[c]), f.shift(), f.push(e[0]), g.shift(), g.push(e[1]), cZ(b, f, g);
    return b.join("");
  }
  function cT(a) {
    var b,
  ...
  function dd(a) {
    function j(f) {
      ...
      var j = cE(this, f, b, d),
        k = cE(this, f, b === c ? de(j) : c, d === e ? df(j) : e);
        ...
        for (var m = 3; m < f; m++) {
          ...
          if (n == 1)
            for (k = g._pack_prev; k !== j._pack_prev; k = k._pack_prev, p++)
              if (ej(k, i)) break;
          n
            ? (o < p || (o == p && h.r < g.r) ? ei(g, (h = j)) : ei((g = k), h),
              m--)
            : (eh(g, i), (h = i), l(i));
        }
      }
  ...
  function eY(a, b) {
    function q(a) {
      ...
      return [
        Math.atan2(i, f) / eJ,
        Math.atan2(l, Math.sqrt(f * f + i * i)) / eJ,
      ];
    }
    var c = a[0] * eJ,
      d = Math.cos(c),
  ...
  function fg(a, b, c, d, e, f) {
    if (!a(b, c, d, e, f)) {
      var g = (c + e) * 0.5,
        h = (d + f) * 0.5,
        i = b.nodes;
      i[0] && fg(a, i[0], c, d, g, h),
        i[1] && fg(a, i[1], g, d, e, h),
        i[2] && fg(a, i[2], c, h, g, f),
        i[3] && fg(a, i[3], g, h, e, f);
    }
  }
  function fh(a) {
    return { x: a[0], y: a[1] };
  ...
  function fx(a, b, c) {
    ...
    return d
      ? (a.setMonth(fz.get(d[0].toLowerCase())), (c += d[0].length))
      : -1;
  }
  function fB(a, b, c) {
  ...
  (d3.functor = function (a) {
    ...
    (d3.mean = function (a, b) {
      ...
      if (arguments.length === 1)
        while (++f < c) p((d = a[f])) && (e += (d - e) / ++g);
      else while (++f < c) p((d = b.call(a, a[f], f))) && (e += (d - e) / ++g);
    ...
    (d3.zip = function () {
      ...
      for (var a = -1, b = d3.min(arguments, q), c = new Array(b); ++a < b; )
  ...
  (d3.bisectLeft = r.left),
    (d3.bisect = d3.bisectRight = r.right),
  ...
  (d3.ns = {
    ...
    qualify: function (a) {
      ...
      return (
        ...
        w.hasOwnProperty(c) ? { space: w[c], local: a } : a
      );
    },
  }),
  ...
  (d3.ease = function (a) {
    ...
    return (
      (c = J.get(c) || I),
      (d = K.get(d) || O),
      L(d(c.apply(null, Array.prototype.slice.call(arguments, 1))))
    );
  }),
    (d3.event = null),
  ...
  (d3.interpolators = [
    ...
    function (a, b) {
      return (
        (typeof b == "string"
          ? bh.has(b) || /^(#|rgb\(|hsl\()/.test(b)
          : b instanceof bc || b instanceof bj) && d3.interpolateRgb(a, b)
      );
    },
    function (a, b) {
  ...
  bh.forEach(function (a, b) {
    ...
    (bj.prototype.brighter = function (a) {
      return (
        (a = Math.pow(0.7, arguments.length ? a : 1)),
        bi(this.h, this.s, this.l / a)
      );
    }),
    (bj.prototype.darker = function (a) {
      return (
        (a = Math.pow(0.7, arguments.length ? a : 1)),
        bi(this.h, this.s, a * this.l)
      );
    }),
  ...
  var bm = function (a, b) {
    ...
    bp =
      bo.matchesSelector ||
      bo.webkitMatchesSelector ||
      bo.mozMatchesSelector ||
  ...
  var bB = [];
  (d3.selection.enter = bA),
    (d3.selection.enter.prototype = bB),
    (bB.append = br.append),
    (bB.insert = br.insert),
    (bB.empty = br.empty),
    (bB.node = br.node),
    (bB.select = function (a) {
      var b = [],
        c,
        d,
        e,
  ...
  var bD = {},
    ...
    bH = 0,
    bI = 0,
    bJ = d3.ease("cubic-in-out");
  (bG.call = br.call),
    (d3.transition = function () {
      return bz.transition();
    }),
    (d3.transition.prototype = bG),
  ...
  (d3.timer = function (a, b, c) {
    ...
    d || (bL = { callback: a, then: c, delay: b, next: bL }),
      bM || ((bN = clearTimeout(bN)), (bM = 1), bQ(bO));
  }),
  ...
  (d3.touches = function (a, b) {
    return (
      arguments.length < 2 && (b = X().touches),
      b
        ? f(b).map(function (b) {
            var c = bX(a, b);
    ...
    (d3.svg.arc = function () {
      function e() {
        var e = a.apply(this, arguments),
          ...
          g = c.apply(this, arguments) + cx,
          h = d.apply(this, arguments) + cx,
  ...
  (d3.svg.axis = function () {
      ...
      k.each(function (l, m, n) {
        var o = d3.select(this),
          p = k.delay
            ...
            : Object,
          q = h == null ? (a.ticks ? a.ticks.apply(a, g) : a.domain()) : h,
          r =
          ...
          u = t
            ...
            .style("opacity", 1e-6),
          v = p(t.exit()).style("opacity", 1e-6).remove(),
          w = p(t).style("opacity", 1),
          x = o.selectAll("g").data(q, String),
          y = x.enter().insert("g", "path").style("opacity", 1e-6),
          z = p(x.exit()).style("opacity", 1e-6).remove(),
          A = p(x).style("opacity", 1),
          B,
          C = b$(a),
          D = o.selectAll(".domain").data([0]),
          E = D.enter().append("path").attr("class", "domain"),
          F = p(D),
          G = a.copy(),
          H = this.__chart__ || G;
        (this.__chart__ = G),
          y.append("line").attr("class", "tick"),
          y.append("text"),
          A.select("text").text(r);
        switch (b) {
          case "bottom":
            (B = du),
              u.attr("y2", d),
              w.attr("x2", 0).attr("y2", d),
              y.select("line").attr("y2", c),
              y.select("text").attr("y", Math.max(c, 0) + f),
              A.select("line").attr("x2", 0).attr("y2", c),
              A.select("text")
                .attr("x", 0)
                .attr("y", Math.max(c, 0) + f)
                .attr("dy", ".71em")
                .attr("text-anchor", "middle"),
              F.attr("d", "M" + C[0] + "," + e + "V0H" + C[1] + "V" + e);
            break;
          case "top":
            (B = du),
              u.attr("y2", -d),
          ...
          case "left":
            (B = dv),
              u.attr("x2", -d),
              w.attr("x2", -d).attr("y2", 0),
              y.select("line").attr("x2", -c),
              y.select("text").attr("x", -(Math.max(c, 0) + f)),
              A.select("line").attr("x2", -c).attr("y2", 0),
              A.select("text")
                .attr("x", -(Math.max(c, 0) + f))
                .attr("y", 0)
                .attr("dy", ".32em")
                .attr("text-anchor", "end"),
              F.attr("d", "M" + -e + "," + C[0] + "H0V" + C[1] + "H" + -e);
            break;
          case "right":
            (B = dv),
              u.attr("x2", d),
    ...
    (d3.svg.brush = function () {
      function f(a) {
        a.each(function () {
          var a = d3.select(this),
            ...
            k = a.selectAll(".extent").data([0]),
            l = a.selectAll(".resize").data(d, String),
            m;
          a
            .style("pointer-events", "all")
            .on("mousedown.brush", j)
            .on("touchstart.brush", j),
            e
              .enter()
              .append("rect")
            ...
            l
              ...
              .attr("height", 6)
              .style("visibility", "hidden"),
            l.style("display", f.empty() ? "none" : null),
            l.exit().remove(),
            b &&
              ((m = b$(b)), e.attr("x", m[0]).attr("width", m[1] - m[0]), h(a)),
            c &&
              ((m = b$(c)),
      ...
      function j() {
        ...
        function x() {
          d3.event.keyCode == 32 &&
            (p || ((q = null), (r[0] -= e[1][0]), (r[1] -= e[1][1]), (p = 2)),
            W());
        }
        function y() {
          d3.event.keyCode == 32 &&
            p == 2 &&
            ((r[0] += e[1][0]), (r[1] += e[1][1]), (p = 0), W());
        }
        function z() {
          var a = w(),
            d = !1;
        ...
        function A(a, b, c) {
          var d = b$(b),
            ...
            k;
          p && ((f -= h), (g -= i + h)),
            (j = Math.max(f, Math.min(g, a[c]))),
            p
              ? (k = (j += h) + i)
              : (q && (h = Math.max(f, Math.min(g, 2 * q[c] - j))),
                h < j ? ((k = j), (j = h)) : (k = h));
          if (e[0][c] !== j || e[1][c] !== k)
            return (e[0][c] = j), (e[1][c] = k), !0;
        }
        function B() {
          z(),
            l
        ...
        var d = this,
          ...
          t = d3
            .select(window)
            .on("mousemove.brush", z)
            .on("mouseup.brush", B)
            .on("touchmove.brush", z)
            .on("touchend.brush", B)
            .on("keydown.brush", x)
            .on("keyup.brush", y);
        if (p) (r[0] = e[0][0] - r[0]), (r[1] = e[0][1] - r[1]);
        else if (m) {
          var u = +/w$/.test(m),
            v = +/^n/.test(m);
          (s = [e[1 - u][0] - r[0], e[1 - v][1] - r[1]]),
            (r[0] = e[u][0]),
            (r[1] = e[v][1]);
        ...
        l
          ...
          .selectAll(".resize")
          .style("display", null),
          d3.select("body").style("cursor", j.style("cursor")),
          k({ type: "brushstart" }),
          z(),
          W();
      }
      var a = Y(f, "brushstart", "brush", "brushend"),
        b,
        c,
        d = dy[0],
        e = [
        ...
        (f.extent = function (a) {
          ...
          return arguments.length
            ...
            : (b &&
                ((d = e[0][0]),
                (g = e[1][0]),
                b.invert && ((d = b.invert(d)), (g = b.invert(g))),
                g < d && ((j = d), (d = g), (g = j))),
              c &&
                ((h = e[0][1]),
                (i = e[1][1]),
  ...
  (d3.behavior = {}),
    (d3.behavior.drag = function () {
      ...
      function d() {
        ...
        function l() {
          d({ type: "dragend" }),
            h && (W(), d3.event.target === e && i.on("click.drag", m, !0)),
            i
      ...
      var a = Y(c, "drag", "dragstart", "dragend"),
        b = null;
      return (
        (c.origin = function (a) {
      ...
      function r() {
        ...
        function i() {
          d && W(),
            ...
            d && d3.event.target === c && e.on("click.zoom", j);
        }
        function j() {
    ...
    (d3.layout.force = function () {
      ...
      return (
        (a.tick = function () {
          ...
          for (h = 0; h < d; ++h) {
            (k = n[h]),
              ...
              (w = s.y - l.y);
            if ((t = v * v + w * w))
              (t = (e * p[h] * ((t = Math.sqrt(t)) - o[h])) / t),
                (v *= t),
                (w *= t),
                (s.x -= v * (u = l.weight / (s.weight + l.weight))),
                (s.y -= w * u),
                (l.x += v * (u = 1 - u)),
                (l.y += w * u);
          }
        ...
        (a.start = function () {
          ...
          for (b = 0; b < f; ++b)
            (r = n[b]),
              typeof r.source == "number" && (r.source = m[r.source]),
              typeof r.target == "number" && (r.target = m[r.target]),
              (o[b] = g.call(this, r, b)),
              (p[b] = h.call(this, r, b)),
              ++r.source.weight,
              ++r.target.weight;
          ...
          if (typeof i == "function")
            for (b = 0; b < e; ++b) q[b] = +i.call(this, m[b], b);
          else for (b = 0; b < e; ++b) q[b] = i;
          return a.resume();
        }),
        (a.resume = function () {
          return a.alpha(0.1);
        ...
        (a.drag = function () {
          d ||
            (d = d3.behavior
              ...
              .on("drag", dK)
              .on("dragend", dJ)),
            this.on("mouseover.force", dH).on("mouseout.force", dI).call(d);
        }),
        d3.rebind(a, b, "on")
      );
    });
  ...
  d3.layout.stack = function () {
    ...
    return (
      ...
      (g.order = function (a) {
        return arguments.length
          ? ((b = typeof a == "function" ? a : dS.get(a) || dU), g)
          : b;
      }),
      (g.offset = function (a) {
        return arguments.length
          ? ((c = typeof a == "function" ? a : dT.get(a) || dV), g)
          : c;
      }),
      (g.x = function (a) {
  ...
  (d3.layout.pack = function () {
    ...
    var a = d3.layout.hierarchy().sort(eg),
      b = [1, 1];
    return (
      (c.size = function (a) {
        return arguments.length ? ((b = a), c) : b;
        ...
        function j(a, c, d) {
          if (c) {
            var e = a,
              ...
              l = h._tree.mod,
              m;
            while (((g = ew(g)), (e = ev(e)), g && e))
              (h = ev(h)),
                (f = ew(f)),
                (f._tree.ancestor = a),
                (m = g._tree.prelim + k - e._tree.prelim - i + b(g, e)),
                m > 0 && (eD(eE(g, a, d), a, m), (i += m), (j += m)),
                (k += g._tree.mod),
                (i += e._tree.mod),
                (l += h._tree.mod),
                (j += f._tree.mod);
            g && !ew(f) && ((f._tree.thread = g), (f._tree.mod += k - j)),
              e &&
                !ev(h) &&
      ...
      return (
        ...
        (n.padding = function (a) {
          function b(b) {
            ...
            return c == null
              ? eF(b)
              : eG(b, typeof c == "number" ? [c, c, c, c] : c);
          }
          function c(b) {
            return eG(b, a);
          }
  ...
  (d3.geo.azimuthal = function () {
    ...
    return (
      (i.invert = function (b) {
        var f = (b[0] - d[0]) / c,
          ...
          m = Math.cos(k);
        return [
          (e + Math.atan2(f * l, j * g * m + i * h * l)) / eJ,
          Math.asin(m * h - (j ? (i * l * g) / j : 0)) / eJ,
        ];
      }),
      (i.mode = function (b) {
    ...
    (d3.geo.albers = function () {
      function i(a) {
        var b = f * (eJ * a[0] - e),
          i = Math.sqrt(g - 2 * f * Math.sin(eJ * a[1])) / f;
    ...
    (d3.geo.mercator = function () {
      function c(c) {
        var d = c[0] / 360,
          e = -(Math.log(Math.tan(Math.PI / 4 + (c[1] * eJ) / 2)) / eJ) / 360;
    ...
    (d3.geo.path = function () {
      function d(c, d) {
        return (
          typeof a == "function" && (b = eL(a.apply(this, arguments))),
          f(c) || null
        );
      }
      function e(a) {
  ...
  (d3.geo.circle = function () {
    ...
    function h(a) {
      ...
      while (++b < e)
        (l = d.distance((j = a[b]))),
          l < c
            ? (h && f.push(eY(h, j)((k - c) / (k - l))),
              f.push(j),
              (g = h = null))
            : ((h = j),
              !g &&
                f.length &&
                (f.push(eY(f[f.length - 1], h)((c - k) / (l - k))), (g = h))),
          (k = l);
      return (
        h &&
          f.length &&
          ((l = d.distance((j = f[0]))), f.push(eY(h, j)((k - c) / (k - l)))),
        i(f)
      );
    }
    function i(a) {
    ...
    var a = [0, 0],
      b = 89.99,
      c = b * eJ,
      d = d3.geo.greatArc().target(Object);
    e.clip = function (b) {
      return (
        ...
        (a.clip = function (b) {
          ...
          while (++d < e) {
            ...
            while (++f < g)
              (k = c[f]),
                fb(k, h, i)
                  ? (fb(j, h, i) || b.push(fc(j, k, h, i)), b.push(k))
                  : fb(j, h, i) && b.push(fc(j, k, h, i)),
                (j = k);
            h = i;
          }
          return b;
  ...
  var fl = d3.format("02d"),
    ...
    ft = /^(?:sun|mon|tue|wed|thu|fri|sat)/i,
    fu = /^(?:Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday)/i;
  d3_time_weekdays = [
    "Sunday",
    "Monday",
    "Tuesday",
  ...
  var fw = d3.map({
    ...
    fy = /^(?:January|February|March|April|May|June|July|August|September|October|November|December)/gi,
    fz = d3.map({
      january: 0,
      february: 1,
      march: 2,
  ...
  (d3.time.format.iso = Date.prototype.toISOString ? fT : fS),
    (fT.parse = function (a) {
      return new Date(a);
    }),
    (fT.toString = fS.toString),
    (d3.time.second = fU(
      function (a) {
