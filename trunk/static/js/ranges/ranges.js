...
function setFactors(factor){
	if (!isCelsius) {
        ...
        d.vel /= 196.9;
		if(factor=="tr"){
		  factor_1 = FtoC(parseFloat(document.getElementById(factor+"1").value));
	      factor_2 = FtoC(parseFloat(document.getElementById(factor+"2").value));
        } else if (factor=="vel"){
